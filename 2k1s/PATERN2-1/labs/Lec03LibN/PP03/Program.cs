...
class Program
{
    static void Main(string[] args)
    {
        ...
        IFactory l1 = Lec03LibN.Lec03BLib.getL1();          // фабрика 1
        IFactory l2 = Lec03LibN.Lec03BLib.getL2(1);          // фабрика 2
        IFactory l3 = Lec03LibN.Lec03BLib.getL3(1, 0.5f);     // фабрика 3
