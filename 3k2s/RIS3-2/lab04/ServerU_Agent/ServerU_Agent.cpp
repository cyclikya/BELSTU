...
// Читаем текущего координатора из config.txt
...
int main(int argc, char* argv[])
{
    ...
    while (true)
    {
        ...
        // Перед каждым запросом заново читаем координатора
        ...
        // Пересылаем запрос текущему координатору
        sendto(
            temp,
            "gettime",
            7,
        ...
        // Возвращаем клиенту ответ координатора
        sendto(
            s,
            buffer,
            rr,
